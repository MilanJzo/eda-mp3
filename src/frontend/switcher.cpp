...
void switcher::onEditPlaylist(const playlist &p) {
    ...
    {
        if (!edit) delete edit;  // Erster Kommentar ;), das hier war der Absturzgrund während der Präsetation, weil das if()-statement fehlte. Behoben am 11.12.24 um 16:43uhr.
